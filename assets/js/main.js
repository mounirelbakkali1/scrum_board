        ...
        <div class="d-flex" id="task-info">
          <div  class="d-flex justify-content-center align-middle p-2"><img src="./assets/img/${icon}" style="width: 25px;height: 25px;" alt="icon-wait"></div>
            <div class="flex-fill p-2">
              <h6 style="width:85%;">${task.title}</h6>
              <p  class="mb-1">#1 Assigned at ${task.date}</p>
          ...
          <div class="d-flex justify-content-end pe-2">
            <button class="px-4" id="type" style="background-color: var(--main-color) ; color: var(--secondary); border:none;  margin-left:5px;border-radius: 10px;" >${task.type}</button>
            <button class="bg-transparent px-4" id="priority" style="border: 2px var(--main-color) solid; margin-left:5px;border-radius: 10px; color:var(--main-color) ;">${task.priority}</button>
          </div>  
      </div>
    </div>
    `;
